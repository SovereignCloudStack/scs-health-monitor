...
class StepsDef:
    ...
    def create_a_jumphost(context, jumphost_name: str, network_name: str, keypair_name: str):
            # config
            ping_sec_group_name = "ping-sg-test"
            ...
            ping_sec_group = tools.check_security_group_exists(context.client, sec_group_name=ping_sec_group_name)
            ...
            for security_group in security_groups:
                security_group = tools.check_security_group_exists(context.client, security_group['name'])
