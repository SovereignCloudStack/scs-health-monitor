...
|net-delete
|net-external-list
|port-create|`createJHPorts()` `createResources()`|[L1942-L1955](https://github.com/SovereignCloudStack/openstack-health-monitor/blob/084e8960d9348af7b3c5c9927a1ebaebf4be48f9/api_monitor.sh#L1942-L1955)|
...
||`create2ndPorts()` `createResources()`|[L1964-L1970](https://github.com/SovereignCloudStack/openstack-health-monitor/blob/084e8960d9348af7b3c5c9927a1ebaebf4be48f9/api_monitor.sh#L1964-L1970)|
|port-delete|`deleteJHPorts()` `deleteResources()`|
...
|[L1982-L1987](https://github.com/SovereignCloudStack/openstack-health-monitor/blob/084e8960d9348af7b3c5c9927a1ebaebf4be48f9/api_monitor.sh#L1982-L1987)| `delete2ndPorts()` `deleteResources()`|
|port-list
|port-show
|port-update
|rename
